...
public class ImageUtils {
   ...
   *
   * @param bitmap The originalImageBitmap to save.
   */
   ...
   *
   * @param bitmap The originalImageBitmap to save.
   * @param filename The location to save the originalImageBitmap to.
   */
  public static void saveBitmap(final Bitmap bitmap, final String filename) {
    final String root =
        Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + "tensorflow";
    LOGGER.i("Saving %dx%d originalImageBitmap to %s.", bitmap.getWidth(), bitmap.getHeight(), root);
