package com.mobileapps.bao.stylit;/* Copyright 2015 The TensorFlow Authors. All Rights Reserved.
...
public final class Logger {
  ...
  /**
   * Creates a com.mobileapps.bao.stylit.Logger using the class name as the message prefix.
   *
  ...
  /**
   * Creates a com.mobileapps.bao.stylit.Logger using the specified message prefix.
   *
  ...
  /**
   * Creates a com.mobileapps.bao.stylit.Logger with a custom tag and a custom message prefix. If the message prefix
  ...
  /**
   * Creates a com.mobileapps.bao.stylit.Logger using the caller's class name as the message prefix.
   */
  public Logger() {
